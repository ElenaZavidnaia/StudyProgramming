...
public class MainProgramm {
    ...
    public static void main(String[] args) {
        ...
        Office chebRoo = new Office(vtb,"РОО «Чебоксарский»"," г. Чебоксары, бульвар Президентский, д. 27А", "1000", true,true,"Все виды услуг");
        ...
        System.out.println(Office.bankName);
    }
}
